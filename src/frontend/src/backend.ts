...
import type { Order as _Order, Product as _Product, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllProductsSortedByCategory(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProductsSortedByCategory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductsByCategoryAndPriceRange(arg0: string, arg1: number, arg2: number): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByCategoryAndPriceRange(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async seedProductsOnce(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedProductsOnce();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
